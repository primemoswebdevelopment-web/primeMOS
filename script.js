...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initGlobalSearch() {
    ...
    const searchIndex = [
      ...
      { title: "GCET Hyderabad VLSI Workshop", description: "Flagship hands-on workshop on ECE to VLSI Chip Design Using Open-Source Tools. Official MoU proposal currently under process.", url: `${prefix}events/#past-events`, category: "event", icon: "fa-microchip" },
      { title: "GCET Official Letter of Appreciation", description: "Official institutional appreciation from Geethanjali College of Engineering & Technology (AUTONOMOUS, NAAC A+, JNTUH).", url: `${prefix}testimonials/`, category: "reviews", icon: "fa-award" },
      { title: "GCET Student Reviews & Feedback", description: "Read verified feedback from A. Karthikeya Reddy, A. Rishi, Durga Prasad Reddy and GCET ECE participants (4.8/5.0).", url: `${prefix}testimonials/`, category: "reviews", icon: "fa-star" },
      { title: "Event Photo Gallery & Moments", description: "Interactive photo showcase of workshops, lab sessions, and felicitations across partner institutions.", url: `${prefix}events/#gallery`, category: "event", icon: "fa-images" },
      ...
      { title: "Collaborations & Institutional Partners", description: "Strategic alliances with GCET (MoU Proposal under process), IETE (Proposal under process), IEEE, VBIT, RRU, and TapeoutX.", url: `${prefix}events/#collaborations`, category: "institutional", icon: "fa-handshake" },
